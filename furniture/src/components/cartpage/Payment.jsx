                        ...
                        <Grid   templateColumns="repeat(2,1fr)" gap="40px">
                            <Box >
                                <FormControl isRequired>
                                    <Input mt={10} name="lname" placeholder='Last name' value={info.lname} onChange={(e) => setInfo({ ...info, [e.target.name]: e.target.value })}/>
                                    <Input mt={10} name="fname" placeholder='First name' value={info.fname} onChange={(e) => setInfo({ ...info, [e.target.name]: e.target.value })} />
